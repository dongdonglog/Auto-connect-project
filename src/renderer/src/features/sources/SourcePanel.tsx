import { FolderOpen, Pause, Play, RefreshCw, Trash2, X } from 'lucide-react'
...
export function SourcePanel({ onClose, onChanged }: { onClose(): void; onChanged(): Promise<void> }): React.ReactElement {
  ...
  const add = async (): Promise<void> => {
    ...
    catch (error) { setMessage(error instanceof Error ? error.message : '无法加入文件夹。') }
