...
export function TopicBoardPage({ map, materials, onRefresh, onImportFiles, onBack }: { map: TopicMap; materials: Material[]; onRefresh(): Promise<void>; onImportFiles(paths: string[], position: { x: number; y: number }): Promise<void>; onBack?: () => void }): React.ReactElement {
