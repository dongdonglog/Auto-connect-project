...
export interface Relation { id:string; sourceMaterialId:string; targetMaterialId:string; label:string; relationType:string; evidenceText?:string|null; evidenceMaterialId?:string|null; confidence?:number|null; createdBy:string; createdAt:string }
export interface TopicMap { topic:Topic; materials:Array<Material & {workstreamId?:string|null}>; workstreams:Workstream[]; relations:Relation[] }
